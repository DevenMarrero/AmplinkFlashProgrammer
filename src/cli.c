...
void print_help() {
    ...
    printf("  -f1=FILENAME    Path to first file (default: flash_2A.hex)\n");
    printf("  -f2=FILENAME    Path to second file (default: flash_3A.hex)\n");
    printf("  -f3=FILENAME    Path to third file (default: flash_4A.hex)\n");
    printf("  -i2c=0xHH         Clock i2c address (default: 0x6A)\n");
